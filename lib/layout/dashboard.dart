...
class _DashboardLayoutState extends State<DashboardLayout>
  ...
  Widget _buildBody(BuildContext context, AsyncSnapshot<User?> snapshot) {
    ...
    return const Padding(
        padding: EdgeInsets.symmetric(horizontal: 15), child: RouterOutlet());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title: Image.asset('assets/images/unc_seal.png', height: 45),
          actions: [
            Padding(
          ...
          child: TabBar(
              ...
              tabs: const [
                Tab(
                    ...
                    child: SizedBox(
                      width: 70,
                      child: Text('Face Mask Violations',
                          style: TextStyle(
                              height: 1.2, fontSize: 10, color: Colors.black),
        ...
        body: FutureBuilder<User?>(
          builder: _buildBody,
          initialData: null,
          future: User.getCurrentUser(Modular.get<AppVariables>()),
        ));
  }
}
